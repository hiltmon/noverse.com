...
if(document.addEventListener ){ 
   ...
   aLoader = [
    { load: "/edge/header/edge_includes/jquery-1.7.1.min.js"},
    { load: "/edge/header/edge_includes/edge.1.5.0.min.js"},
          { load: "/edge/header/index_edge.js"},
          { load: "/edge/header/index_edgeActions.js"}];
